...
With the idea of length of horizontal curves, the \textbf{distance between two points} $ p,q\in M $  is defined as the infimum of the lengths of all absolutely continuous\footnote{A curve $ \gamma:I\subset \mathbb{R}  \rightarrow {M} $ is said to be absolutely continuous if it has derivative for almost all $ t\in I. $ } horizontal curves that begin in $ p $ and end in $ q $  
%\newpage
