...
%DIF ADD main.tex       Sat Jul 16 21:56:27 2022
% Title of Document: 
% Start Date: 
%%%%%%%%%%%%%%%%%%%%%%%%
%%%FINAL CHECK%%%%%%%%%
...
%DIFDELCMD < %%%
\DIFdelend are a morphism of vector bundles.
\DIFaddbegin \end{df}
\DIFaddend \begin{df}
